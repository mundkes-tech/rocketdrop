          ...
          <div className="flex justify-center mb-6 space-x-4">
            {['user', 'supplier'].map((r) => (
              <button
                ...
                type="button"
                onClick={() => setRole(r)}
                className={`cursor-pointer px-6 py-3 rounded-full font-medium border transition ${
                  role === r
          ...
          <form onSubmit={handleRegister} className="grid grid-cols-1 gap-6">
            ...
            <button
              ...
              className={`cursor-pointer mt-4 bg-gradient-to-r from-[#004a7c] to-[#005691] text-white py-3 rounded-full font-semibold 
                hover:opacity-90 transition shadow-md flex items-center justify-center ${
...
//   {/* Background Image */}
//   <Image
//     src="/Images/form.jpg"        // use /public path
//     alt="Register Illustration"
//     fill
//     className="object-cover opacity-30 absolute top-0 left-0 z-0"
//     priority
...
//       Welcome to RocketDrop
//     </h1>
//     <p className="text-lg mb-6 text-[#011f4b]">
//       Join our platform and start selling globally with ease.
//     </p>
//   </div>
// </div>
...
//     bg-gradient-to-br from-[#e8f1f5] to-[#e8f1f5]  <!-- light blue background -->
//     p-8 sm:p-12 rounded-l-3xl shadow-2xl">
//         <div className="w-full max-w-md">
...
//           <p className="text-center mt-6 text-gray-600 text-sm">
//             Already have an account?{' '}
//             <Link href="/login" className="text-[#2C5670] font-medium hover:underline">
//               Sign in
//             </Link>
//           </p>
//         </div>
...
//         onChange={onChange}
//         required={required}
//         placeholder=" " // must be space for peer-placeholder-shown to work
//         className="peer w-full border border-gray-300 rounded-lg px-4 pt-5 pb-3 text-gray-900 placeholder-transparent 
// focus:outline-none focus:ring-2 focus:ring-[#004a7c]/60
